...
--
-- Solo hay un jugador local, así que `kec.player` YA es la instancia (no una fábrica como
...
---@return boolean
function kec.player:isDead()
    return IsPlayerDead(PlayerId())
end

---@param toggle boolean
function kec.player:setInvincible(toggle)
    SetPlayerInvincible(PlayerId(), toggle)
end

---@return boolean
function kec.player:isInvincible()
...
---@param modifier number
function kec.player:setMeleeDamageModifier(modifier)
...
function kec.player:setMeleeDefenseModifier(modifier)
