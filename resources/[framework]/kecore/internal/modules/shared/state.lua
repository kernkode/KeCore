...
--
-- El cargador conserva la tabla completa que devuelve esta fábrica, incluida su metatabla; no la
-- copia clave por clave.
-- ------------------------------------------------------------
...
--- @return table state
return function(initial, owner)
    local stateValues = initial or {}
    local stateListeners = {}
    local thisResource = owner or GetCurrentResourceName()
