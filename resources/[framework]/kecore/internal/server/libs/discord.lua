...
---
function kec.discord:createRole(guildId, roleData, cb)
...
---
function kec.discord:createRoleSync(guildId, roleData)
    local promise = promise.new()
...
---
function kec.discord:deleteRole(guildId, roleId, cb)
...
---
function kec.discord:deleteRoleSync(guildId, roleId)
    local promise = promise.new()
...
---
function kec.discord:getRole(guildId, roleId, cb)
    if not guildId or not roleId then
...
---
function kec.discord:getAllRoles(guildId, cb)
    if not guildId then
...
---@param cb function Callback que recibe (error, success).
---
function kec.discord:removeUserRole(guildId, targetDiscordId, roleId, cb)
...
---
function kec.discord:removeUserRoleSync(guildId, targetDiscordId, roleId)
    local promise = promise.new()
...
---
function kec.discord:modifyRole(guildId, roleId, roleData, cb)
...
---
function kec.discord:modifyRoleSync(guildId, roleId, roleData)
    local promise = promise.new()
...
---@param cb function Callback que recibe (error, success)
---
function kec.discord:changeRoleName(guildId, roleId, newName, cb)
...
---
function kec.discord:changeRoleNameSync(guildId, roleId, newName)
    local promise = promise.new()
