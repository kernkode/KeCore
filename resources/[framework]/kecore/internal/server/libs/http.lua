...
-- API Pública
function kec.http:get(path, cb) addRoute('GET', path, cb) end
function kec.http:post(path, cb) addRoute('POST', path, cb) end
function kec.http:put(path, cb) addRoute('PUT', path, cb) end
function kec.http:delete(path, cb) addRoute('DELETE', path, cb) end
