-- AUTO-GENERATED from internal/server/vehicle/ — DO NOT EDIT
...
-- ============================================================
-- Vehicle Info (memoria en servidor)
-- ============================================================
local vehicle_info = {}
...
-- ============================================================
-- Factory (con metatabla para rendimiento óptimo)
-- ============================================================
local vehicle_meta = { __index = vehicle_methods }
...
local function instance_vehicle(entity)
    ...
    local vtype = GetEntityType(entity)

    if entity == INVALID_ENTITY_ID or vtype ~= ENTITY_TYPE_VEHICLE then return "Error" end
    ...
    return setmetatable(instance, vehicle_meta)
end
