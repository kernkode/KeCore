-- AUTO-GENERATED from internal/client/vehicle/header.lua + client/vehicle/impl.lua by scripts/builder/gen-performance.ts — DO NOT EDIT
...
---@param entity integer
---@return integer
function vehicle:classOf(entity)
...
---@param entity integer
---@return boolean
function vehicle:isAircraft(entity)
...
---@param entity integer
---@return boolean
function vehicle:isCycle(entity)
    return isCycleClass(classOf(entity))
end

function vehicle:get(entity)
